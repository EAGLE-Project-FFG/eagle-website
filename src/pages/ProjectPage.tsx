...
export function MethodologySection() {
  return (
    <section className="mx-auto mt-10 max-w-6xl">
      <Card className="rounded-2xl border bg-white/90 px-1 py-1 shadow-lg">
        <CardContent className="p-6 md:p-8">
          ...
          <p className="mb-6 text-base">
            ...
            contributions:{" "}
            <span className="font-medium">(1) flexible EAKG creation,</span>{" "}
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {/* Contribution 1 */}
            <Card className="rounded-xl border bg-muted/20 px-1 py-1 shadow-none">
              <CardContent className="flex h-full flex-col p-5">
                <div className="mb-4 flex items-center gap-2">
                  <Database className="h-5 w-5 text-primary" />
                  <h3 className="text-lg font-semibold">1. EAKG Creation</h3>
                </div>
        ...
        <Card className="rounded-2xl border bg-white/90 px-1 py-1 shadow-lg">
          <CardContent className="p-6 md:p-8">
            ...
            <p className="text-base font-medium">
              ...
              combining Knowledge Graphs (KGs) and AI.
            </p>
            <p className="mt-2 text-base text-muted-foreground">
              The framework helps organizations model, manage, and query
              architecture assets with semantic consistency and adaptability.
            </p>
              ...
              <ol className="space-y-5">
                <li className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      A unified, extensible schema that integrates heterogeneous
                      data sources.
                    </p>
                  </div>
                </li>
                ...
                <li className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Natural-language access for all stakeholders, without
            ...
            <div className="grid gap-6 md:grid-cols-[55%_45%]">
              ...
              <div className="space-y-4">
                <p className="text-base">
                  ...
                  is increasingly vital for aligning complex IT landscapes with
                  evolving business strategies. While established frameworks
                  such as
                  <span className="font-medium"> ArchiMate</span> and
                  <span className="font-medium"> TOGAF</span> provide valuable
                  structure, they remain largely manual, static, and
                  disconnected from many critical data sources. As organizations
                  face
                  <span className="font-medium">
                    {" "}
                  ...
                  , rising demands for{" "}
                  <span className="font-medium">real-time insights</span>, and
                  an ever-expanding variety of
                  <span className="font-medium"> EA-relevant information</span>,
                  these traditional approaches struggle to deliver on the full
                  potential of EAM. This results in a persistent gap between the{" "}
                  <span className="font-medium">
                    theoretical benefits of EA
                  </span>{" "}
                  and its
                  <span className="font-medium"> practical impact</span>, a gap
                  EAGLE aims to close.
                </p>
                ...
                <div className="grid gap-3">
                  <div className="rounded-xl bg-muted/30 p-3">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Unify models, documents, spreadsheets, tool outputs, and
                      other data sources in a coherent, semantic schema.
                    </p>
                  </div>
                  ...
                  <div className="rounded-xl bg-muted/30 p-3">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Simulate scenarios and automate what-if analyses to reveal
                      risks, impacts, and better future states.
                    </p>
                  </div>
